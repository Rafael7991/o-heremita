...
import KeyboardState from './assets/KeyboardState.js';
import {CSG} from  "./assets/CSGMesh.js";
import {GLTFLoader} from './assets/GLTFLoader.js';
import {FontLoader} from './assets/FontLoader.js';
import {TextGeometry} from './assets/TextGeometry.js';


let renderer, camera, keyboard;
...
let cone = new THREE.Mesh(
    new THREE.ConeGeometry(1,2,20,20),
    new THREE.MeshBasicMaterial({color: 0xff0000})
);
renderer = initRenderer();
var tex_portais = new THREE.TextureLoader().load( 'assets/textures/pedra_01.png' );
var lookAtVec   = new THREE.Vector3( 0.0, 0.0, 0.0 );
var camPosition = new THREE.Vector3(0,0,3);
...
plane1.position.set(-80,15,0);

plane2.position.set(-86,18,0);
...
loader.load( 'assets/fonts/helvetiker_regular.typeface.json', function ( font ) {
  ...
  textMesh = new THREE.Mesh(texto, [new THREE.MeshPhongMaterial({emissive: 0x0019EC, emissiveIntensity: 0.5}),new THREE.MeshPhongMaterial({color: 0xF5F904})]);
  textMesh.rotateY(Math.PI);
  textMesh.position.set(-68,11,11);
} );
...
loader.load( 'assets/fonts/helvetiker_regular.typeface.json', function ( font ) {
  ...
  textMesh2 = new THREE.Mesh(texto2, [new THREE.MeshPhongMaterial({emissive: 0x00000, emissiveIntensity: 0.5}),new THREE.MeshPhongMaterial({color: 0xF1500A})]);
  textMesh2.rotateY(Math.PI);
  textMesh2.position.set(-68,11,-6);
} );
...
let clicouCA1 = false;
let clicouCA2 = false;
let CVE1_plataforma = false;
let CVE2_plataforma = false;
let prob1 = false;
let prob2 = false;
let prob3 = false;
let prob4 = false;
let aux_clique;
let obj1_ponte = false;
let obj2_ponte = false;
let obj3_ponte = false;
let obj4_ponte = false;
let obj5_ponte = false;
let obj6_ponte = false;
let obj7_plataforma = false;
let obj8_plataforma = false;
let obj9_plataforma = false;
let obj10_plataforma = false;
let obj11_plataforma = false;
let obj12_plataforma = false;
...
CSGFin1.material = new THREE.MeshPhongMaterial({map: tex_portais});
CSGFin2.material = new THREE.MeshPhongMaterial({map: tex_portais});
CSGFin3.material = new THREE.MeshPhongMaterial({map: tex_portais});
CSGFin1.position.set(1,10.5,55.75);
CSGFin2.position.set(77.25,-21,0.75);
CSGFin2.rotateY(Math.PI/2);
CSGFin3.position.set(-56,11,0);
...
let CSGFinal4 = CSGFinal1.clone();
let CSGFinal5 = CSGFinal2.clone();
let CSGFinal6 = CSGFinal3.clone();
CSGFinal4.position.set(0,-0.4,0);
CSGFinal4.scale.set(0.8,0.25,0.7);
CSGFinal4.rotateZ(Math.PI/2);
CSGFinal5.position.set(0.5,-0.4,0);
CSGFinal5.scale.set(0.8,0.25,0.7);
CSGFinal5.rotateZ(Math.PI/2);
CSGFinal6.position.set(1,-0.4,0);
CSGFinal6.scale.set(0.8,0.25,0.7);
CSGFinal6.rotateZ(Math.PI/2);
...
const doorOpen = new THREE.Audio(listener)
audioLoader.load('./assets/sounds/porta.mp3', function(buffer){
  doorOpen.setBuffer(buffer);
  doorOpen.setLoop(false);
  doorOpen.setVolume(1.0);
});

// SOM DA CHAVE
const takeKey = new THREE.Audio(listener)
audioLoader.load('./assets/sounds/chave.mp3', function(buffer){
  takeKey.setBuffer(buffer);
  takeKey.setLoop(false);
  takeKey.setVolume(1.0);
});

// SOM DA PONTE
const putBridge = new THREE.Audio(listener)
audioLoader.load('./assets/sounds/ponte.mp3', function(buffer){
  putBridge.setBuffer(buffer);
  putBridge.setLoop(false);
  putBridge.setVolume(1.0);
});

//SOM DA PLATAFORMA
const platform = new THREE.Audio(listener)
audioLoader.load('./assets/sounds/plataforma.mp3', function(buffer){
  platform.setBuffer(buffer);
  platform.setLoop(false);
  platform.setVolume(1.0);
});

// SOM DA SALA DE VITÓRIA
const victory = new THREE.Audio(listener)
audioLoader.load('./assets/sounds/vitoria.mp3', function(buffer){
  victory.setBuffer(buffer);
  victory.setLoop(false);
  victory.setVolume(1.0);
});

var tex_bordas = new THREE.TextureLoader().load( 'assets/textures/brik_1.png' );
tex_bordas.wrapS = THREE.RepeatWrapping;
tex_bordas.wrapT = THREE.RepeatWrapping;
tex_bordas.repeat.set( 8,1 );
tex_bordas.anisotropy = 16;
tex_bordas.encoding = THREE.sRGBEncoding;

  const borda1 = new THREE.Mesh(
  new THREE.BoxGeometry(30,4,1),
  new THREE.MeshPhongMaterial({map: tex_bordas})
);
...
var tex_bordas3 = new THREE.TextureLoader().load( 'assets/textures/brik_4.png' );
tex_bordas3.wrapS = THREE.RepeatWrapping;
tex_bordas3.wrapT = THREE.RepeatWrapping;
tex_bordas3.repeat.set( 8,1 );
tex_bordas3.anisotropy = 16;
tex_bordas3.encoding = THREE.sRGBEncoding;
//parte 1
const borda1ACenario1 = new THREE.Mesh(
  new THREE.BoxGeometry(30,4,1),
  new THREE.MeshPhongMaterial({map: tex_bordas3})
);
...
var tex_bordas2 = new THREE.TextureLoader().load( 'assets/textures/bkred_1.png' );
tex_bordas2.wrapS = THREE.RepeatWrapping;
tex_bordas2.wrapT = THREE.RepeatWrapping;
tex_bordas2.repeat.set( 32,1 );
tex_bordas2.anisotropy = 16;
tex_bordas2.encoding = THREE.sRGBEncoding;

//parte 1
const borda1ACenario2 = new THREE.Mesh(
  new THREE.BoxGeometry(32,4,1),
  new THREE.MeshPhongMaterial({map: tex_bordas2})
);
...
var tex_bordas6 = new THREE.TextureLoader().load( 'assets/textures/brik_3.png' );
tex_bordas6.wrapS = THREE.RepeatWrapping;
tex_bordas6.wrapT = THREE.RepeatWrapping;
tex_bordas6.repeat.set( 8,1 );
tex_bordas6.anisotropy = 16;
tex_bordas6.encoding = THREE.sRGBEncoding;
//parte 1
const borda1ACenario3 = new THREE.Mesh(
  new THREE.BoxGeometry(70,4,1),
  new THREE.MeshPhongMaterial({map: tex_bordas6})
);
...
var tex_bordas4 = new THREE.TextureLoader().load( 'assets/textures/brik_6.png' );
tex_bordas4.wrapS = THREE.RepeatWrapping;
tex_bordas4.wrapT = THREE.RepeatWrapping;
tex_bordas4.repeat.set( 8,1 );
tex_bordas4.anisotropy = 16;
tex_bordas4.encoding = THREE.sRGBEncoding;
//****************** BORDA DO SENTIDO NEGATIVO DO EIXO Z */
//parte 1
const borda1ACenario4 = new THREE.Mesh(
  new THREE.BoxGeometry(30,4,1),
  new THREE.MeshPhongMaterial({map: tex_bordas4})
);
borda1ACenario4.position.set(-72, 13, -15);
...
borda2ACenario4.position.set(-72, 13, 15);
...
borda3ACenario4.position.set(-56.5, 13, -9);
...
borda3BCenario4.position.set(-56.5, 13, 9);
...
borda4ACenario4.position.set(-87, 13, 0);
...
//******************************* OBJETO QUE COBRE OS PLANOS */
//OBJETO QUE COBRE O CENÁRIO 1
const objCenario1 = new THREE.Mesh(
  new THREE.BoxGeometry(70,1,70),
  new THREE.MeshPhongMaterial({color:0xE6C585, opacity: 0.5, transparent: true})
);
objCenario1.position.set(0,-12,-90);
objCenario1.castShadow = false;
objCenario1.receiveShadow = false;
objCenario1.name = "objCenario1";
scene.add(objCenario1);

//OBJETO QUE COBRE O CENÁRIO 2
const objCenario2 = new THREE.Mesh(
  new THREE.BoxGeometry(70,1,70),
  new THREE.MeshPhongMaterial({color:0xE6C585, opacity: 0.5, transparent: true})
);
objCenario2.position.set(0,9,90);
objCenario2.castShadow = false;
objCenario2.receiveShadow = false;
objCenario2.name = "objCenario3";
scene.add(objCenario2);

//OBJETO QUE COBRE O CENÁRIO 3
const objCenario3 = new THREE.Mesh(
  new THREE.BoxGeometry(70,1,70),
  new THREE.MeshPhongMaterial({color:0xE6C585, opacity: 0.5, transparent: true})
);
objCenario3.position.set(111.5,-22,0);
objCenario3.castShadow = false;
objCenario3.receiveShadow = false;
objCenario3.name = "objCenario3";
scene.add(objCenario3);

const bola1 = new THREE.Mesh(
  new THREE.SphereGeometry(0.5,5,5),
  new THREE.MeshPhongMaterial({emissive: 0xfef600}),
)
bola1.position.set(-54, 26 , -0.3);

const bola2 = new THREE.Mesh(
  new THREE.SphereGeometry(0.5,5,5),
  new THREE.MeshPhongMaterial({emissive: 0x0023FF}),
)
bola2.position.set(2,25.5,53);

const bola3 = new THREE.Mesh(
  new THREE.SphereGeometry(0.5,5,5),
  new THREE.MeshPhongMaterial({emissive: 0xFF0000}),
)
bola3.position.set(78.7,-6,0);

scene.add(bola1, bola2, bola3);
...
//CENÁRIO 1
var tex_bordas9 = new THREE.TextureLoader().load( 'assets/textures/crate.jpg' );
tex_bordas9.wrapS = THREE.RepeatWrapping;
tex_bordas9.wrapT = THREE.RepeatWrapping;
tex_bordas9.repeat.set( 1,1 );
tex_bordas9.anisotropy = 16;
tex_bordas9.encoding = THREE.sRGBEncoding;

const obj1 = new THREE.Mesh(
  new THREE.BoxGeometry(5,1,3),
  new THREE.MeshPhongMaterial({map: tex_bordas9})
);
...
const obj7 = new THREE.Mesh(
  new THREE.BoxGeometry(2,4.2,2),
  new THREE.MeshPhongMaterial({color: 0xE6C585})
);

obj7.name = "7";
obj7.position.set(-10 , 10 , 100);
...
caixaVerde1.uuid = "NS";
caixaVerde1.position.set(0 , 10.5 , 115);
...
caixaVerde2.uuid = "NS";
caixaVerde2.position.set(15 , 10.5 , 115);
...
caixaVerde3.uuid = "NS";
caixaVerde3.position.set(-15 , 10.5 , 115);
...
caixaVermelha1.position.set(96,-21.2,0);
caixaVermelha1.name = "CVE1";
...
caixaVermelha2.position.set(120,-21.2,12);
caixaVermelha2.name = "CVE2";
...
caixaAmarela1.position.set(135,-21.6,-3);
...
caixaAmarela2.position.set(130,-21.6,-20);
...
const ponte1 = new THREE.Mesh(
  ...
  new THREE.MeshPhongMaterial({color: 0x000000, opacity: 1, transparent: true})
);
ponte1.position.set(1.5 , -11.7 , -126.5);
ponte1.name = "ponte1";
ponte1.uuid = "NP";

const ponte2 = ponte1.clone();
ponte2.position.set(-1.5, -11.7, -126.5);
ponte2.name = "ponte2";
ponte2.uuid = "NP";

const ponte3 = ponte1.clone();
ponte3.position.set(1.5, -11.7, -129.5);
ponte3.name = "ponte3";
ponte3.uuid = "NP";

const ponte4 = ponte1.clone();
ponte4.position.set(-1.5, -11.7, -129.5);
ponte4.name = "ponte4";
ponte4.uuid = "NP";

const ponte5 = ponte1.clone();
ponte5.position.set(1.5, -11.7, -132.5);
ponte5.name = "ponte5";
ponte5.uuid = "NP";

const ponte6 = ponte1.clone();
ponte6.position.set(-1.5, -11.7, -132.5);
ponte6.name = "ponte6";
ponte6.uuid = "NP";
...
loadAudio(loadingManager, 'assets/sounds/majula.mp3');
carrega_man('assets/objects/walkingMan.glb', false);
loadGLTFFile('assets/objects/','chair', 5, 180, true);
loadGLTFFile('assets/objects/', 'crate_box', 2.5, 90, true);
loadGLTFObject(loadingManager, 'assets/objects/torch/scene.gltf');
var aux_cadeira1, aux_cadeira2, aux_cadeira3, aux_cadeira4, aux_cadeira5, aux_cadeira6;
var aux_caixa1, aux_caixa2;
addJoysticks();
render();
...
function carrega_man(modelName, centerObject)
{
...
function loadGLTFFile(modelPath, modelName, desiredScale, angle, visibility)
{
  ...
  loader.load( modelPath + modelName + '.glb', function ( gltf ) {
     ...
     objeto.visible = visibility;
     objeto.name = getFilename(modelName);
     ...
     var objeto = normalizeAndRescale(objeto, desiredScale);
     var objeto = fixPosition(objeto);
     objeto.rotateY(THREE.MathUtils.degToRad(angle));

     if(modelName=='crate_box')
      {
        aux_caixa1 = objeto;
        aux_caixa2 = aux_caixa1.clone();
        aux_caixa1.visible = false;
        aux_caixa2.visible = false;
     }
     else
     {
      aux_cadeira1 = objeto;
      aux_cadeira2 = aux_cadeira1.clone();
      aux_cadeira3 = aux_cadeira1.clone();
      aux_cadeira4 = aux_cadeira1.clone();
      aux_cadeira5 = aux_cadeira1.clone();
      aux_cadeira6 = aux_cadeira1.clone();
     }
     scene.add (aux_cadeira1, aux_cadeira2, aux_cadeira3, aux_cadeira4, aux_cadeira5, aux_cadeira6, aux_caixa1, aux_caixa2);
     assetManager[modelName] = objeto;
  });
}
function onError() { };
...
function render()
{
  ...
  aux_cadeira1.position.set(obj7.position.x, obj7.position.y, obj7.position.z);
  aux_cadeira1.rotation.set(obj7.rotation.x, obj7.rotation.y, obj7.rotation.z);
  aux_cadeira2.position.set(obj8.position.x, obj8.position.y, obj8.position.z);
  aux_cadeira2.rotation.set(obj8.rotation.x, obj8.rotation.y, obj8.rotation.z);
  aux_cadeira3.position.set(obj9.position.x, obj9.position.y, obj9.position.z);
  aux_cadeira3.rotation.set(obj9.rotation.x, obj9.rotation.y, obj9.rotation.z);
  aux_cadeira4.position.set(obj10.position.x, obj10.position.y, obj10.position.z);
  aux_cadeira4.rotation.set(obj10.rotation.x, obj10.rotation.y, obj10.rotation.z);
  aux_cadeira5.position.set(obj11.position.x, obj11.position.y, obj11.position.z);
  aux_cadeira5.rotation.set(obj11.rotation.x, obj11.rotation.y, obj11.rotation.z);
  aux_cadeira6.position.set(obj12.position.x, obj12.position.y, obj12.position.z);
  aux_cadeira6.rotation.set(obj12.rotation.x, obj12.rotation.y, obj12.rotation.z);
  aux_caixa1.position.set(caixaVermelha1.position.x, caixaVermelha1.position.y, caixaVermelha1.position.z);
  aux_caixa1.rotation.set(caixaVermelha1.rotation.x, caixaVermelha1.rotation.y, caixaVermelha1.rotation.z);
  aux_caixa2.position.set(caixaVermelha2.position.x, caixaVermelha2.position.y, caixaVermelha2.position.z);
  aux_caixa2.rotation.set(caixaVermelha2.rotation.x, caixaVermelha2.rotation.y, caixaVermelha2.rotation.z);
  man.scale.set(2,2,2);
  /**************** USA A FUNÇÃO LERP PARA AS PLATAFORMAS VERDES E CAIXAS DO CENÁRIO 2 */
  if(caixaVerde1.uuid == "S" && obj7_plataforma == true)
  {
    if(moveCaixaVerde1 < 1 && moveObj7 < 1)
    {
      caixaVerde1.position.y = lerp(10.5, 9.5, moveCaixaVerde1);
      obj7.position.y = lerp(11.5, 10.5, moveObj7)
      moveCaixaVerde1 += 0.01;
      moveObj7 += 0.01;
    }
  }
  if(caixaVerde1.uuid == "S" && obj8_plataforma == true)
  {
    if(moveCaixaVerde1 < 1 && moveObj8 < 1)
    {
      caixaVerde1.position.y = lerp(10.5, 9.5, moveCaixaVerde1);
      obj8.position.y = lerp(11.5, 10.5, moveObj8)
      moveCaixaVerde1 += 0.01;
      moveObj8 += 0.01;
    }
  }
  if(caixaVerde1.uuid == "S" && obj9_plataforma == true)
  {
    if(moveCaixaVerde1 < 1 && moveObj9 < 1)
    {
      caixaVerde1.position.y = lerp(10.5, 9.5, moveCaixaVerde1);
      obj9.position.y = lerp(11.5, 10.5, moveObj9)
      moveCaixaVerde1 += 0.01;
      moveObj9 += 0.01;
    }
  }
  if(caixaVerde1.uuid == "S" && obj10_plataforma == true)
  {
    if(moveCaixaVerde1 < 1 && moveObj10 < 1)
    {
      caixaVerde1.position.y = lerp(10.5, 9.5, moveCaixaVerde1);
      obj10.position.y = lerp(11.5, 10.5, moveObj10)
      moveCaixaVerde1 += 0.01;
      moveObj10 += 0.01;
    }
  }
  if(caixaVerde1.uuid == "S" && obj11_plataforma == true)
  {
    if(moveCaixaVerde1 < 1 && moveObj11 < 1)
    {
      caixaVerde1.position.y = lerp(10.5, 9.5, moveCaixaVerde1);
      obj11.position.y = lerp(11.5, 10.5, moveObj11)
      moveCaixaVerde1 += 0.01;
      moveObj11 += 0.01;
    }
  }
  if(caixaVerde1.uuid == "S" && obj12_plataforma == true)
  {
    if(moveCaixaVerde1 < 1 && moveObj12 < 1)
    {
      caixaVerde1.position.y = lerp(10.5, 9.5, moveCaixaVerde1);
      obj12.position.y = lerp(11.5, 10.5, moveObj12)
      moveCaixaVerde1 += 0.01;
      moveObj12 += 0.01;
    }
  }
  if(caixaVerde2.uuid == "S" && obj7_plataforma == true)
  {
    if(moveCaixaVerde2 < 1 && moveObj7 < 1)
    {
      caixaVerde2.position.y = lerp(10.5, 9.5, moveCaixaVerde2);
      obj7.position.y = lerp(11.5, 10.5, moveObj7)
      moveCaixaVerde2 += 0.01;
      moveObj7 += 0.01;
    }
  }
  if(caixaVerde2.uuid == "S" && obj8_plataforma == true)
  {
    if(moveCaixaVerde2 < 1 && moveObj8 < 1)
    {
      caixaVerde2.position.y = lerp(10.5, 9.5, moveCaixaVerde2);
      obj8.position.y = lerp(11.5, 10.5, moveObj8)
      moveCaixaVerde2 += 0.01;
  ...
  if(caixaVerde2.uuid == "S" && obj9_plataforma == true)
  {
    if(moveCaixaVerde2 < 1 && moveObj9 < 1)
    {
      caixaVerde2.position.y = lerp(10.5, 9.5, moveCaixaVerde2);
      obj9.position.y = lerp(11.5, 10.5, moveObj9)
      moveCaixaVerde2 += 0.01;
  ...
  if(caixaVerde2.uuid == "S" && obj10_plataforma == true)
  {
    if(moveCaixaVerde2 < 1 && moveObj10 < 1)
    {
      caixaVerde2.position.y = lerp(10.5, 9.5, moveCaixaVerde2);
      obj10.position.y = lerp(11.5, 10.5, moveObj10)
      moveCaixaVerde2 += 0.01;
  ...
  if(caixaVerde2.uuid == "S" && obj11_plataforma == true)
  {
    if(moveCaixaVerde2 < 1 && moveObj11 < 1)
    {
      caixaVerde2.position.y = lerp(10.5, 9.5, moveCaixaVerde2);
      obj11.position.y = lerp(11.5, 10.5, moveObj11)
      moveCaixaVerde2 += 0.01;
  ...
  if(caixaVerde2.uuid == "S" && obj12_plataforma == true)
  {
    if(moveCaixaVerde2 < 1 && moveObj12 < 1)
    {
      caixaVerde2.position.y = lerp(10.5, 9.5, moveCaixaVerde2);
      obj12.position.y = lerp(11.5, 10.5, moveObj12)
      moveCaixaVerde2 += 0.01;
  ...
  if(caixaVerde3.uuid == "S" && obj7_plataforma == true)
  {
    if(moveCaixaVerde3 < 1 && moveObj7 < 1)
    {
      caixaVerde3.position.y = lerp(10.5, 9.5, moveCaixaVerde3);
      obj7.position.y = lerp(11.5, 10.5, moveObj7)
      moveCaixaVerde3 += 0.01;
      moveObj7 += 0.01;
    }
  }
  if(caixaVerde3.uuid == "S" && obj8_plataforma == true)
  {
    if(moveCaixaVerde3 < 1 && moveObj8 < 1)
    {
      caixaVerde3.position.y = lerp(10.5, 9.5, moveCaixaVerde3);
      obj8.position.y = lerp(11.5, 10.5, moveObj8)
      moveCaixaVerde3 += 0.01;
  ...
  if(caixaVerde3.uuid == "S" && obj9_plataforma == true)
  {
    if(moveCaixaVerde3 < 1 && moveObj9 < 1)
    {
      caixaVerde3.position.y = lerp(10.5, 9.5, moveCaixaVerde3);
      obj9.position.y = lerp(11.5, 10.5, moveObj9)
      moveCaixaVerde3 += 0.01;
  ...
  if(caixaVerde3.uuid == "S" && obj10_plataforma == true)
  {
    if(moveCaixaVerde3 < 1 && moveObj10 < 1)
    {
      caixaVerde3.position.y = lerp(10.5, 9.5, moveCaixaVerde3);
      obj10.position.y = lerp(11.5, 10.5, moveObj10)
      moveCaixaVerde3 += 0.01;
  ...
  if(caixaVerde3.uuid == "S" && obj11_plataforma == true)
  {
    if(moveCaixaVerde3 < 1 && moveObj11 < 1)
    {
      caixaVerde3.position.y = lerp(10.5, 9.5, moveCaixaVerde3);
      obj11.position.y = lerp(11.5, 10.5, moveObj11)
      moveCaixaVerde3 += 0.01;
  ...
  if(caixaVerde3.uuid == "S" && obj12_plataforma == true)
  {
    if(moveCaixaVerde3 < 1 && moveObj12 < 1)
    {
      caixaVerde3.position.y = lerp(10.5, 9.5, moveCaixaVerde3);
      obj12.position.y = lerp(11.5, 10.5, moveObj12)
      moveCaixaVerde3 += 0.01;
  ...
  /********************************************************************************* */
  //USA A FUNÇÃO LERP PARA AS PLATAFORMAS AMARELAS E CAIXAS VERMELHAS DO CENÁRIO 3
  if(prob1 == true)
  {
    if(moveCA1A < 1 && moveCV1A < 1)
    {
      caixaAmarela1.position.y = lerp(-21.6, -22.2, moveCA1A);
      caixaVermelha1.position.y = lerp(-20.5, -21.2, moveCV1A);
      moveCA1A += 0.01;
      moveCV1A += 0.01;
    }
  }
  if(prob2 == true)
  {
    if(moveCA1B < 1 && moveCV1B < 1)
    {
      caixaAmarela1.position.y = lerp(-21.6, -22.2, moveCA1B);
      caixaVermelha2.position.y = lerp(-20.5, -21.2, moveCV1B);
      moveCA1B += 0.01;
      moveCV1B += 0.01;
    }
  }
  if(prob3 == true)
  {
    if(moveCA2A < 1 && moveCV2A < 1)
    {
      caixaAmarela2.position.y = lerp(-21.6, -22.2, moveCA2A);
      caixaVermelha1.position.y = lerp(-20.5, -21.2, moveCV2A);
      moveCA2A += 0.01;
      moveCV2A += 0.01;
    }
  }
  if(prob4 == true)
  {
    if(moveCA2B < 1 && moveCV2B < 1)
    {
      caixaAmarela2.position.y = lerp(-21.6, -22.2, moveCA2B);
      caixaVermelha2.position.y = lerp(-20.5, -21.2, moveCV2B);
      moveCA2B += 0.01;
      moveCV2B += 0.01;
    }
  }
...
function update()
{
  if(man.position.x < -85 && man.position.z> -2.25 && man.position.z < 2.25 && man.position.y > 18){
    stop = true;
    victory.play();
  ...
  renderer.setViewport(0,0,200,40);
  renderer.setScissor(0,0,200,40);
  renderer.setScissorTest(true);
  renderer.render(scene2, virtualCamera);


  if(keyboard.pressed("T"))
  {
    if(redKey == false || yellowKey == false || blueKey == false)
    {
      takeKey.play();
      redKey = true;
      yellowKey = true;
      blueKey = true;
      scene2.add(CSGFinal4,CSGFinal5,CSGFinal6);
    }
  }
  ...
  if(man.position.x < 1 && man.position.x > -3 && man.position.y <11.5 && man.position.y > 10 && man.position.z > 131 && man.position.z < 133){
    ...
    redKey = true;
    scene2.add(CSGFinal6);
    scene.remove(CSGFinal3);
  }

  if(man.position.x < 152 && man.position.x > 148 && man.position.y <-19 && man.position.y > -22 && man.position.z > -5 && man.position.z < 2){
    if(yellowKey == false)
    {
      takeKey.play();
    }
    yellowKey = true;
    scene2.add(CSGFinal5);
  ...
  if(man.position.x > 95 && man.position.x < 97 && man.position.z < 34.5 && man.position.z > 34)
  {
  ...
  //caixa amarela 2
  if(man.position.x > 133 && man.position.x < 135 && man.position.z < 34.5 && man.position.z > 34)
  {
  ...
  if(lftValue > 0)
  {
    ...
    else if(((bounds.xMin < collisions[15].xMax) && (bounds.xMin > collisions[15].xMin) && (bounds.zMax > collisions[15].zMin - 1) && (bounds.zMin < collisions[15].zMax )) ||  ((bounds.zMin < collisions[15].zMax) && (bounds.zMin > collisions[15].zMin) && (bounds.xMax > collisions[15].xMin - 1) && (bounds.xMin < collisions[15].xMax)))
    {
    ...
    else if(((bounds.xMin < collisions[16].xMax) && (bounds.xMin > collisions[16].xMin) && (bounds.zMax > collisions[16].zMin - 1) && (bounds.zMin < collisions[16].zMax )) ||  ((bounds.zMin < collisions[16].zMax) && (bounds.zMin > collisions[16].zMin) && (bounds.xMax > collisions[16].xMin - 1) && (bounds.xMin < collisions[16].xMax)))
    {
    ...
    else if(((bounds.xMin < collisions[17].xMax) && (bounds.xMin > collisions[17].xMin) && (bounds.zMax > collisions[17].zMin - 1) && (bounds.zMin < collisions[17].zMax )) ||  ((bounds.zMin < collisions[17].zMax) && (bounds.zMin > collisions[17].zMin) && (bounds.xMax > collisions[17].xMin - 1) && (bounds.xMin < collisions[17].xMax)))
    {
    ...
    else if(((bounds.xMin < collisions[18].xMax) && (bounds.xMin > collisions[18].xMin) && (bounds.zMax > collisions[18].zMin - 1) && (bounds.zMin < collisions[18].zMax )) ||  ((bounds.zMin < collisions[18].zMax) && (bounds.zMin > collisions[18].zMin) && (bounds.xMax > collisions[18].xMin - 1) && (bounds.xMin < collisions[18].xMax)))
    {
  ...
  if(rgtValue > 0)
  {
    ...
    {
      if(man.position.x< -55.5 && !yellowKey){
        man.position.x -= 0;
        cube2.position.x -= 0;
        man.position.y -= 0;
        cube2.position.y -= 0;
    ...
    else if(((bounds.xMin < collisions[15].xMax) && (bounds.xMin > collisions[15].xMin) && (bounds.zMin < collisions[15].zMax + 1) && (bounds.zMax > collisions[15].zMin)) || ((bounds.zMin < collisions[15].zMax) && (bounds.zMin > collisions[15].zMin) && (bounds.xMin < collisions[15].xMax + 1) && (bounds.xMax > collisions[15].xMin)))
    {
      if(caixaVermelha1.uuid == "S")
      {
        //não se move
    ...
    else if(((bounds.xMin < collisions[16].xMax) && (bounds.xMin > collisions[16].xMin) && (bounds.zMin < collisions[16].zMax + 1) && (bounds.zMax > collisions[16].zMin)) || ((bounds.zMin < collisions[16].zMax) && (bounds.zMin > collisions[16].zMin) && (bounds.xMin < collisions[16].xMax + 1) && (bounds.xMax > collisions[16].xMin)))
    {
      if(caixaVermelha2.uuid == "S")
      {
        //não se move
    ...
    else if(((bounds.xMin < collisions[17].xMax) && (bounds.xMin > collisions[17].xMin) && (bounds.zMin < collisions[17].zMax + 1) && (bounds.zMax > collisions[17].zMin)) || ((bounds.zMin < collisions[17].zMax) && (bounds.zMin > collisions[17].zMin) && (bounds.xMin < collisions[17].xMax + 1) && (bounds.xMax > collisions[17].xMin)))
    {
      if(caixaAmarela1.uuid == "S")
      {
        //não se move
    ...
    else if(((bounds.xMin < collisions[18].xMax) && (bounds.xMin > collisions[18].xMin) && (bounds.zMin < collisions[18].zMax + 1) && (bounds.zMax > collisions[18].zMin)) || ((bounds.zMin < collisions[18].zMax) && (bounds.zMin > collisions[18].zMin) && (bounds.xMin < collisions[18].xMax + 1) && (bounds.xMax > collisions[18].xMin)))
    {
      if(caixaAmarela2.uuid == "S")
      {
        //não se move
  ...
  if(fwdValue > 0)
  {
    ...
    else if(((bounds.zMin < collisions[15].zMax) && (bounds.zMin > collisions[15].zMin) && (bounds.xMin < collisions[15].xMax + 1) && (bounds.xMax > collisions[15].xMin)) || ((bounds.xMin < collisions[15].xMax) && (bounds.xMin > collisions[15].xMin) && (bounds.zMax > collisions[15].zMin - 1) && (bounds.zMin < collisions[15].zMax )))
    {
      if(caixaVermelha1.uuid == "S")
      {
        //não se move
    ...
    else if(((bounds.zMin < collisions[16].zMax) && (bounds.zMin > collisions[16].zMin) && (bounds.xMin < collisions[16].xMax + 1) && (bounds.xMax > collisions[16].xMin)) || ((bounds.xMin < collisions[16].xMax) && (bounds.xMin > collisions[16].xMin) && (bounds.zMax > collisions[16].zMin - 1) && (bounds.zMin < collisions[16].zMax )))
    {
      if(caixaVermelha2.uuid == "S")
      {
        //não se move
    ...
    else if(((bounds.zMin < collisions[17].zMax) && (bounds.zMin > collisions[17].zMin) && (bounds.xMin < collisions[17].xMax + 1) && (bounds.xMax > collisions[17].xMin)) || ((bounds.xMin < collisions[17].xMax) && (bounds.xMin > collisions[17].xMin) && (bounds.zMax > collisions[17].zMin - 1) && (bounds.zMin < collisions[17].zMax )))
    {
      if(caixaAmarela1.uuid == "S")
      {
        //não se move
    ...
    else if(((bounds.zMin < collisions[18].zMax) && (bounds.zMin > collisions[18].zMin) && (bounds.xMin < collisions[18].xMax + 1) && (bounds.xMax > collisions[18].xMin)) || ((bounds.xMin < collisions[18].xMax) && (bounds.xMin > collisions[18].xMin) && (bounds.zMax > collisions[18].zMin - 1) && (bounds.zMin < collisions[18].zMax )))
    {
      if(caixaAmarela2.uuid == "S")
      {
        //não se move
  ...
  if(bkdValue > 0)
  {
    ...
    else if(((bounds.zMin < collisions[15].zMax) && (bounds.zMin > collisions[15].zMin) && (bounds.xMax > collisions[15].xMin - 1) && (bounds.xMin < collisions[15].xMax)) || ((bounds.xMin < collisions[15].xMax) && (bounds.xMin > collisions[15].xMin) && (bounds.zMin < collisions[15].zMax + 1) && (bounds.zMax > collisions[15].zMin)))
    {
      if(caixaVermelha1.uuid == "S")
      {
        //não se move
    ...
    else if(((bounds.zMin < collisions[16].zMax) && (bounds.zMin > collisions[16].zMin) && (bounds.xMax > collisions[16].xMin - 1) && (bounds.xMin < collisions[16].xMax)) || ((bounds.xMin < collisions[16].xMax) && (bounds.xMin > collisions[16].xMin) && (bounds.zMin < collisions[16].zMax + 1) && (bounds.zMax > collisions[16].zMin)))
    {
      if(caixaVermelha2.uuid == "S")
      {
        //não se move
    ...
    else if(((bounds.zMin < collisions[17].zMax) && (bounds.zMin > collisions[17].zMin) && (bounds.xMax > collisions[17].xMin - 1) && (bounds.xMin < collisions[17].xMax)) || ((bounds.xMin < collisions[17].xMax) && (bounds.xMin > collisions[17].xMin) && (bounds.zMin < collisions[17].zMax + 1) && (bounds.zMax > collisions[17].zMin)))
    {
      if(caixaAmarela1.uuid == "S")
      {
        //não se move
    ...
    else if(((bounds.zMin < collisions[18].zMax) && (bounds.zMin > collisions[18].zMin) && (bounds.xMax > collisions[18].xMin - 1) && (bounds.xMin < collisions[18].xMax)) || ((bounds.xMin < collisions[18].xMax) && (bounds.xMin > collisions[18].xMin) && (bounds.zMin < collisions[18].zMax + 1) && (bounds.zMax > collisions[18].zMin)))
    {
      if(caixaAmarela2.uuid == "S")
      {
        //não se move
...
function recalculateCollisionPoints(mesh, indice, type = 'collision')
{
  var bbox = new THREE.Box3().setFromObject(mesh);
...
{
  var tiles_chao = new THREE.TextureLoader().load( 'assets/textures/piso_05.png' );
 tiles_chao.wrapS = tiles_chao.wrapT = THREE.RepeatWrapping;
 tiles_chao.repeat.set( 40, 40 );
 tiles_chao.anisotropy = 16;
 tiles_chao.encoding = THREE.sRGBEncoding;
...
{
  var tiles_chao = new THREE.TextureLoader().load( 'assets/textures/piso_06.png' );
  tiles_chao.wrapS = tiles_chao.wrapT = THREE.RepeatWrapping;
  tiles_chao.repeat.set( 40, 40 );
  tiles_chao.anisotropy = 16;
  tiles_chao.encoding = THREE.sRGBEncoding;
...
{
  var tiles_chao = new THREE.TextureLoader().load( 'assets/textures/piso_07.png' );
 tiles_chao.wrapS = tiles_chao.wrapT = THREE.RepeatWrapping;
 tiles_chao.repeat.set( 40, 40 );
 tiles_chao.anisotropy = 16;
 tiles_chao.encoding = THREE.sRGBEncoding;
...
function createGroundCenario3(width, height, widthSegments = 10, heightSegments = 10, lineWidth = 3, gcolor = null, wcolor = null) {
  var tiles_chao = new THREE.TextureLoader().load( 'assets/textures/piso_09.png' );
  tiles_chao.wrapS = tiles_chao.wrapT = THREE.RepeatWrapping;
  tiles_chao.repeat.set( 40, 40 );
  tiles_chao.anisotropy = 16;
  tiles_chao.encoding = THREE.sRGBEncoding;
...
function createGroundCenarioFinal(width, height, widthSegments = 10, heightSegments = 10, lineWidth = 3, gcolor = null, wcolor = null) {
  var tiles_chao = new THREE.TextureLoader().load( 'assets/textures/piso_08.png' );
 tiles_chao.wrapS = tiles_chao.wrapT = THREE.RepeatWrapping;
 tiles_chao.repeat.set( 40, 40 );
 tiles_chao.anisotropy = 16;
 tiles_chao.encoding = THREE.sRGBEncoding;
...
function onDocMouseDown(event){
  ...
  var intersects_four = raycaster.intersectObjects([caixaVerde1, caixaVerde2, caixaVerde3]);
  var intersects_five = raycaster.intersectObjects([caixaAmarela1, caixaAmarela2]);
  var intersects_six = raycaster.intersectObjects([caixaVermelha1, caixaVermelha2]);
  var intersects_plans = raycaster.intersectObjects([objCenario1, objCenario2, objCenario3]);

  // USO DO RAYCASTER PARA COLOCAR AS CAIXAS DO CENÁRIO 1 DE VOLTA NO PLANO
  if(intersects_two.length == 0 && intersects_plans.length > 0 && select == true)
  {
    if (aux_clique == "1")
    {
      //0
      obj1.position.y = -11;
      obj1.rotation.set(0,-3.15,0);
      select = false;
      recalculateCollisionPoints(obj1, 0);
    }
    if (aux_clique == "2")
    {
      //1
      obj2.position.y = -11;
      obj2.rotation.set(0,-3.15,0);
      select = false;
      recalculateCollisionPoints(obj2, 1);
    }
    if (aux_clique == "3")
    {
      //2
      obj3.position.y = -11;
      obj3.rotation.set(0,-3.15,0);
      select = false;
      recalculateCollisionPoints(obj3, 2);
    }
    if (aux_clique == "4")
    {
      //3
      obj4.position.y = -11;
      obj4.rotation.set(0,-3.15,0);
      select = false;
      recalculateCollisionPoints(obj4, 3);
    }
    if (aux_clique == "5")
    {
      //4
      obj5.position.y = -11;
      obj5.rotation.set(0,-3.15,0);
      select = false;
      recalculateCollisionPoints(obj5, 4);
    }
    if (aux_clique == "6")
    {
      //5
      obj6.position.y = -11;
      obj6.rotation.set(0,-3.15,0);
      select = false;
      recalculateCollisionPoints(obj6, 5);
    }
  }

  if(intersects_four.length == 0 && intersects_plans.length > 0 && select == true)
  {
    if (aux_clique == "7")
    {
      //7
      obj7.position.y = 11;
      obj7.rotation.set(0,0,0);
      select = false;
      recalculateCollisionPoints(obj7, 6);
    }
    if (aux_clique == "8")
    {
      //8
      obj8.position.y = 11;
      obj8.rotation.set(0,0,0);
      select = false;
      recalculateCollisionPoints(obj8, 7);
    }
    if (aux_clique == "9")
    {
      //9
      ...
      select = false;
      recalculateCollisionPoints(obj9, 8);
    }
    if (aux_clique == "10")
    {
      //10
      obj10.position.y = 11;
      obj10.rotation.set(0,0,0);
      select = false;
      recalculateCollisionPoints(obj10, 9);
    }
    if (aux_clique == "11")
    {
      //11
      obj11.position.y = 11;
      obj11.rotation.set(0,0,0);
      select = false;
      recalculateCollisionPoints(obj11, 10);
    }
    if (aux_clique == "12")
    {
      //12
      obj12.position.y = 11;
      obj12.rotation.set(0,0,0);
      select = false;
      recalculateCollisionPoints(obj12, 11);
    }
  }
  
  // USO DO RAYCASTER PARA COLOCAR A CAIXA VERMELHA DE VOLTA NO PLANO
  if(intersects_five.length == 0 && intersects_plans.length > 0 && select == true)
  {
    if (aux_clique == "CVE1")
    {
      //15
      caixaVermelha1.position.y = -21.2;
      select = false;
      recalculateCollisionPoints(caixaVermelha1, 15);
    }
    if (aux_clique == "CVE2")
    {
      //16
      caixaVermelha2.position.y = -21.2;
      select = false;
      recalculateCollisionPoints(caixaVermelha2, 16);
    }
  }
/******************************************************************** CENÁRIO 1 */
// FUNÇÃO PARA SELECIONAR OS CUBOS DO CENÁRIO 1
if(intersects.length > 0 && select == false)
{
  if(intersects[0].object.name == "1" && obj1_ponte == false)
  {
    if(man.position.z - 4 <= intersects[0].object.position.z && man.position.z + 4 >= intersects[0].object.position.z)
    {
      intersects[0].object.position.y += 1;
      objectSel = intersects[0].object;
      select = true;
      aux_clique = "1";
      collisions[0].xMin = null;
      collisions[0].xMax = null;
      collisions[0].zMin = null;
      collisions[0].zMax = null;
    }
  }
  if(intersects[0].object.name == "2" && obj2_ponte == false)
  {
    if(man.position.z - 4 <= intersects[0].object.position.z && man.position.z + 4 >= intersects[0].object.position.z)
    {
      intersects[0].object.position.y += 1;
      ...
      select = true;
      aux_clique = "2";
      collisions[1].xMin = null;
      collisions[1].xMax = null;
      collisions[1].zMin = null;
      collisions[1].zMax = null;
    }
  }
  if(intersects[0].object.name == "3" && obj3_ponte == false)
  {
    if(man.position.z - 4 <= intersects[0].object.position.z && man.position.z + 4 >= intersects[0].object.position.z)
    {
      intersects[0].object.position.y += 1;
      ...
      select = true;
      aux_clique = "3";
      collisions[2].xMin = null;
      collisions[2].xMax = null;
      collisions[2].zMin = null;
      collisions[2].zMax = null;
    }
  }
  if(intersects[0].object.name == "4" && obj4_ponte == false)
  {
    if(man.position.z - 4 <= intersects[0].object.position.z && man.position.z + 4 >= intersects[0].object.position.z)
    {
      intersects[0].object.position.y += 1;
      ...
      select = true;
      aux_clique = "4";
      collisions[3].xMin = null;
      collisions[3].xMax = null;
      collisions[3].zMin = null;
      collisions[3].zMax = null;
    }
  }
  if(intersects[0].object.name == "5" && obj5_ponte == false)
  {
    if(man.position.z - 4 <= intersects[0].object.position.z && man.position.z + 4 >= intersects[0].object.position.z)
    {
      intersects[0].object.position.y += 1;
      ...
      select = true;
      aux_clique = "5";
      collisions[4].xMin = null;
      collisions[4].xMax = null;
      collisions[4].zMin = null;
      collisions[4].zMax = null;
    }
  }
  if(intersects[0].object.name == "6" && obj6_ponte == false)
  {
    if(man.position.z - 4 <= intersects[0].object.position.z && man.position.z + 4 >= intersects[0].object.position.z)
    {
      intersects[0].object.position.y += 1;
      ...
      select = true;
      aux_clique = "6";
      collisions[5].xMin = null;
      collisions[5].xMax = null;
      collisions[5].zMin = null;
      collisions[5].zMax = null;
    }
  }
}
//FUNÇÃO PARA COLOCAR O CUBO SELECIONADO NA PONTE
if(intersects_two.length > 0 && select == true)
{
  if(intersects_two[0].object.name == "ponte1")
  {
    ...
    {
      objectSel.position.set(2.5, -11.5, -126.5);
      objectSel.rotation.set(0,-3.15,0);
      objectSel == null;
      select = false;
      intersects_two[0].object.uuid = "P";
      putBridge.play();
    }
    if(aux_clique == "1"){ obj1_ponte = true }
    if(aux_clique == "2"){ obj2_ponte = true }
    if(aux_clique == "3"){ obj3_ponte = true }
    if(aux_clique == "4"){ obj4_ponte = true }
    if(aux_clique == "5"){ obj5_ponte = true }
    if(aux_clique == "6"){ obj6_ponte = true }
  }
  ...
  if(intersects_two[0].object.name == "ponte3")
  {
    if(intersects_two[0].object.uuid == "NP")
    {
      objectSel.position.set(2.5, -11.5, -129.5);
      objectSel.rotation.set(0,-3.15,0);
      objectSel == null;
      select = false;
      intersects_two[0].object.uuid = "P";
  ...
  if(intersects_two[0].object.name == "ponte5")
  {
    if(intersects_two[0].object.uuid == "NP")
    {
      objectSel.position.set(2.5, -11.5, -132.5);
      objectSel.rotation.set(0,-3.15,0);
      objectSel == null;
      select = false;
      intersects_two[0].object.uuid = "P";
...
/****** CENÁRIO 2 */
  ...
  if(intersects_three.length > 0 && select == false)
  {
    ...
    {
      if(man.position.z - 4 <= intersects_three[0].object.position.z && man.position.z + 4 >= intersects_three[0].object.position.z)
      {
        intersects_three[0].object.position.y += 1;
        objectSel = intersects_three[0].object;
        select = true;
        aux_clique = "7";
        collisions[6].xMin = null;
        collisions[6].xMax = null;
        collisions[6].zMin = null;
    ...
    if(intersects_three[0].object.name == "8")
    {
      if(man.position.z - 4 <= intersects_three[0].object.position.z && man.position.z + 4 >= intersects_three[0].object.position.z)
      {
        ...
        select = true;
        aux_clique = "8";
        collisions[7].xMin = null;
        collisions[7].xMax = null;
        collisions[7].zMin = null;
    ...
    if(intersects_three[0].object.name == "9")
    {
      if(man.position.z - 4 <= intersects_three[0].object.position.z && man.position.z + 4 >= intersects_three[0].object.position.z)
      {
        ...
        select = true;
        aux_clique = "9";
        collisions[8].xMin = null;
        collisions[8].xMax = null;
        collisions[8].zMin = null;
    ...
    if(intersects_three[0].object.name == "10")
    {
      if(man.position.z - 4 <= intersects_three[0].object.position.z && man.position.z + 4 >= intersects_three[0].object.position.z)
      {
        ...
        select = true;
        aux_clique = "10";
        collisions[9].xMin = null;
        collisions[9].xMax = null;
        collisions[9].zMin = null;
    ...
    if(intersects_three[0].object.name == "11")
    {
      if(man.position.z - 4 <= intersects_three[0].object.position.z && man.position.z + 4 >= intersects_three[0].object.position.z)
      {
        ...
        select = true;
        aux_clique = "11";
        collisions[10].xMin = null;
        collisions[10].xMax = null;
        collisions[10].zMin = null;
    ...
    if(intersects_three[0].object.name == "12")
    {
      if(man.position.z - 4 <= intersects_three[0].object.position.z && man.position.z + 4 >= intersects_three[0].object.position.z)
      {
        ...
        select = true;
        aux_clique = "12";
        collisions[11].xMin = null;
        collisions[11].xMax = null;
        collisions[11].zMin = null;
        collisions[11].zMax = null;
      }
    }
  }

  //USO DO RAYCASTER PARA COLOCAR OS CUBOS SELECIONADOS NAS PLATAFORMAS COM CUBOS VERDES
  if(intersects_four.length > 0 && select == true)
  {
    if(intersects_four[0].object.name == "CV1" && intersects_four[0].object.uuid == "NS")
    {
      if(aux_clique == "7")
      {
        obj7.position.set(0, 11.5, 115);
        obj7.rotation.set(0,0,0);
        select = false;
        caixaVerde1.uuid = "S";
        obj7_plataforma = true;
        platform.play();
      }
      if(aux_clique == "8")
      {
        obj8.position.set(0, 11.5, 115);
        obj8.rotation.set(0,0,0);
        select = false;
        caixaVerde1.uuid = "S";
        obj8_plataforma = true;
        platform.play();
      }
      if(aux_clique == "9")
      {
        obj9.position.set(0, 11.5, 115);
        obj9.rotation.set(0,0,0);
        select = false;
        caixaVerde1.uuid = "S";
        obj9_plataforma = true;
        platform.play();
      }
      if(aux_clique == "10")
      {
        obj10.position.set(0, 11.5, 115);
        obj10.rotation.set(0,0,0);
        select = false;
        caixaVerde1.uuid = "S";
        obj10_plataforma = true; 
        platform.play(); 
      }
      if(aux_clique == "11")
      {
        obj11.position.set(0, 11.5, 115);
        obj11.rotation.set(0,0,0);
        select = false;
        caixaVerde1.uuid = "S";
        obj11_plataforma = true;
        platform.play();
      }
      if(aux_clique == "12")
      {
        obj12.position.set(0, 11.5, 115);
        obj12.rotation.set(0,0,0);
        select = false;
        caixaVerde1.uuid = "S";
        obj12_plataforma = true;
        platform.play();
      }
    }
    if(intersects_four[0].object.name == "CV2" && intersects_four[0].object.uuid == "NS")
    {
      if(aux_clique == "7")
      {
        obj7.position.set(15,11.5,115);
        obj7.rotation.set(0,0,0);
        select = false;
        caixaVerde2.uuid = "S";
        obj7_plataforma = true;
      ...
      if(aux_clique == "10")
      {
        obj10.position.set(15,11.5,115);
        obj10.rotation.set(0,0,0);
        select = false;
        caixaVerde2.uuid = "S";
        obj10_plataforma = true;
      ...
      if(aux_clique == "11")
      {
        obj11.position.set(15,11.5,115);
        obj11.rotation.set(0,0,0);
        select = false;
        caixaVerde2.uuid = "S";
        obj11_plataforma = true;
      ...
      if(aux_clique == "12")
      {
        obj12.position.set(15,11.5,115);
        obj12.rotation.set(0,0,0);
        select = false;
        caixaVerde2.uuid = "S";
        obj12_plataforma = true;
    ...
    if(intersects_four[0].object.name == "CV3" && intersects_four[0].object.uuid == "NS")
    {
      if(aux_clique == "7")
      {
        obj7.position.set(-15,11.5,115);
...
/******************************************************************** CENÁRIO 3 */
  //USO DO RAYCASTER PARA SELECIONAR OS CUBOS VERMELHOS DO CENÁRIO 3
  if(intersects_six.length > 0 && select == false)
  {
    if(intersects_six[0].object.name == "CVE1" && aux_caixa1.visible == true && CVE1_plataforma == false)
    {
      intersects_six[0].object.position.y += 1;
      objectSel = intersects_six[0].object;
      select = true;
      aux_clique = "CVE1";
      collisions[15].xMin = null;
      collisions[15].xMax = null;
      collisions[15].zMin = null;
      collisions[15].zMax = null;
    }
    if(intersects_six[0].object.name == "CVE2" && aux_caixa2.visible == true && CVE2_plataforma == false)
    {
      intersects_six[0].object.position.y += 1;
      objectSel = intersects_six[0].object;
      select = true;
      aux_clique = "CVE2";
      collisions[16].xMin = null;
      collisions[16].xMax = null;
      collisions[16].zMin = null;
      collisions[16].zMax = null;
    }
  }
  //USO DO RAYCASTER PARA COLOCAR OS CUBOS VERMELHOS NAS PLATAFORMAS AMARELAS DO CENÁRIO 3
  if(intersects_five.length > 0 && select == true)
  {
    if(caixaVermelha1.uuid == "S" || caixaVermelha2.uuid == "S")
    {
      if(intersects_five[0].object.name == "caixaA1" && objectSel.name == "CVE1")
      {
        caixaVermelha1.position.set(135,-20,-3);
        caixaVermelha1.rotation.set(0,1.5,0);
        select = false;
        objectSel = null;
        prob1 = true;
        clicouCA1 = true;
        CVE1_plataforma = true;
        platform.play();
      }
      if(intersects_five[0].object.name == "caixaA1" && objectSel.name == "CVE2")
      {
        caixaVermelha2.position.set(135,-20,-3);
        caixaVermelha2.rotation.set(0,1.5,0);
        select = false;
        objectSel = null;
        prob2 = true;
        clicouCA1 = true;
        CVE2_plataforma = true;
        platform.play();
      }
      if(intersects_five[0].object.name == "caixaA2" && objectSel.name == "CVE1")
      {
        caixaVermelha1.position.set(130,-20,-20)
        caixaVermelha1.rotation.set(0,1.5,0);
        select = false;
        objectSel = null;
        prob3 = true;
      ...
      if(intersects_five[0].object.name == "caixaA2" && objectSel.name == "CVE2")
      {
        caixaVermelha2.position.set(130,-20,-20)
        caixaVermelha2.rotation.set(0,1.5,0);
        select = false;
        objectSel = null;
        prob4 = true;
