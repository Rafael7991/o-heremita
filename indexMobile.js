...
function loadGLTFFile(modelPath, modelName, desiredScale, angle, visibility)
{
  ...
  loader.load( modelPath + modelName + '.glb', function ( gltf ) {
     var cadeira = gltf.scene;
     cadeira.visible = visibility;
     cadeira.name = getFilename(modelName);
     cadeira.traverse( function ( child ) {
     if ( child ) {
        child.castShadow = true;
     }
     });
     cadeira.traverse( function( node )
     {
        if( node.material ) node.material.side = THREE.DoubleSide;
     });

     var cadeira = normalizeAndRescale(cadeira, desiredScale);
     var cadeira = fixPosition(cadeira);
     cadeira.rotateY(THREE.MathUtils.degToRad(angle));

     if(modelName=='crate_box')
      {
        cadeira.position.set(0,0,0);
        cadeira.getWorldPosition(objectsWorldPosition);
        cadeira.rotation.set(0,1,0);
     }
     else
     {
      aux_cadeira1 = cadeira;
     ...
     scene.add (aux_cadeira1, aux_cadeira2, aux_cadeira3, aux_cadeira4, aux_cadeira5, aux_cadeira6);
     assetManager[modelName] = cadeira;
  });
}
...
scene.add( camera );
message.changeMessage("Posição do boneco: ( UP: " + objectsWorldPosition.x  + ", LEFT:" + objectsWorldPosition.y + ", RIGHT: " + objectsWorldPosition.z + " BACK: "  + ")" );
}
...
function render()
{
  ...
  if(prob1 == true)
  {
    if(moveCA1A < 1 && moveCV1A < 1)
    {
      ...
      caixaVermelha1.position.y = lerp(-19, -20.5, moveCV1A);
      moveCA1A += 0.01;
      moveCV1A += 0.01;
      console.log("Entrou no lerp 1");
    }
  }
  if(prob2 == true)
  {
    if(moveCA1B < 1 && moveCV1B < 1)
    {
      ...
      caixaVermelha2.position.y = lerp(-19, -20.5, moveCV1B);
      moveCA1B += 0.01;
      moveCV1B += 0.01;
      console.log("Entrou no lerp 2");
    }
  }
  if(prob3 == true)
  {
    if(moveCA2A < 1 && moveCV2A < 1)
    {
      ...
      caixaVermelha1.position.y = lerp(-19, -20.5, moveCV2A);
      moveCA2A += 0.01;
      moveCV2A += 0.01;
      console.log("Entrou no lerp 3");
    }
  }
  if(prob4 == true)
  {
    if(moveCA2B < 1 && moveCV2B < 1)
    {
      ...
      caixaVermelha2.position.y = lerp(-19, -20.5, moveCV2B);
      moveCA2B += 0.01;
      moveCV2B += 0.01;
      console.log("Entrou no lerp 4");
    }
  }
...
/******************************************************************** CENÁRIO 3 */
  ...
  {
    if(intersects_six[0].object.name == "CVE1" && caixaVermelha1.visible == true && CVE1_plataforma == false)
    {
    ...
    if(intersects_six[0].object.name == "CVE2" && caixaVermelha2.visible == true && CVE2_plataforma == false)
    {
      intersects_six[0].object.position.y += 1;
      objectSel = intersects_six[0].object;
      select = true;
